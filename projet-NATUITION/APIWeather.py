...
import socket.Server as serveur
import time
import json

#socket -> server.py (ex par database) ->getlocation 
class APIWeather(object):
	"""docstring for APIWeather"""
	def __init__(self, secIntervall):
				#Key generated by the api to call
		self.apiKey = "5848ff07bb54b0148626562ffda70065"
		#Getting data from Server Class
		self.coords = server.Server.getLocation()
		self.lat = 
		self.lon = 
		...
		self.secIntervall = secIntervall
